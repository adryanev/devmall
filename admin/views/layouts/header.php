        ...
        <div class="kt-header__topbar-item dropdown">
            <div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="30px,0px" aria-expanded="true">
									<span class="kt-header__topbar-icon kt-pulse kt-pulse--brand">
										...
										</svg> <b><sup><?= count($notif) ?></sup> </b></span>
                </span>
                ...
                <form>
                    ...
                    <div class="kt-head kt-head--skin-dark kt-head--fit-x kt-head--fit-b"
                        ...
                        <h3 class="kt-head__title">
                            ...
                            &nbsp;
                            <span
                                class="btn btn-success btn-sm btn-bold btn-font-md"> <?= count($notif) ?> UnRead</span>
                        </h3>
                        <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-success kt-notification-item-padding-x"
                            role="tablist">
                            <li class="nav-item">
                                <!--  <a class="nav-link active show" data-toggle="tab" href="#topbar_notifications_notifications" role="tab" aria-selected="true">Notif</a> -->
                            </li>
                        </ul>
                    </div>
