                        ...
                        <div class="kt-section__body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    ...
                                    <span class="form-text text-muted">Email will not be publicly displayed. <a href="#"
                    ...
                    <div class="kt-section kt-section--last">
                        <div class="kt-section__body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-9">
                                    <button type="button"
                                            class="btn btn-outline-primary btn-sm kt-margin-t-5 kt-margin-b-5">Setup
                                        login verification
                                    </button>
                            ...
                            <div class="form-group row kt-margin-t-10 kt-margin-b-10">
                                ...
                                <div class="col-9">
                                    <button type="button"
                                            class="btn btn-outline-danger btn-sm kt-margin-t-5 kt-margin-b-5">Deactivate
                                        your account ?
                                    </button>
                                </div>
                            </div>
