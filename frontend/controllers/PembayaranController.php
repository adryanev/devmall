...
//        $transaksi->total = $req['total'];
    ...
    public function actionNotifikasi()
    {
        ...
        $pembayaran->update(false);

        if($pembayaran->type === TransaksiProduk::TRANSAKSI_PRODUK){
            $detailTransaksi = $pembayaran->transaksiProduk->transaksiDetails;
            $total = $pembayaran->nominal;
            foreach ($detailTransaksi as $detail){
                $booth = $detail->produk->id_booth;
                $coin = Coin::findOne(['id_booth'=>$booth]);
    ...
    public function actionTesting(){
        $pembayaran = Pembayaran::findOne(4);
        var_dump($pembayaran->transaksiProduk->transaksiDetails);
        exit();

//        $transaksi = TransaksiProduk::findOne(4);
//        var_dump($transaksi->pembayarans);
//        exit();
    }
