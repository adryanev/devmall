 ...
 * @var $cicilan common\models\TransaksiCicilan
 * @var $profilUser common\models\ProfilUser
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="information_module order_summary">
                            <div class="toggle_title">
                                <h4>Kode Transaksi (<?= Html::a($cicilan->transaksi->code,
                                        ['pembelian/view', 'id' => $cicilan->transaksi->id],
                                        ['target' => '_blank']) ?> )</h4>
                            ...
                            <ul>
                                <li class="item">
                                    <?= Html::a('Harga Keseluruhan',
                                        '') ?>
                                    <span><?= Yii::$app->formatter->asCurrency($cicilan->transaksi->grand_total) ?></span>
                                </li>
                                <li class="item">
                                    <?= Html::a('Cicilan','') ?>
                                    <span><?= Yii::$app->formatter->asCurrency($cicilan->jumlah_cicilan) ?></span>
                                </li>
...
$url = Url::to(['pembayaran/confirm-cicilan']);
$id = $cicilan->id;
$js = <<<JS
var dataProduk = {id:$id}
