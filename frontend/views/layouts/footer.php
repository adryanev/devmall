    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12 fea-column-inner">
                <div class="fea-box">
                    <div class="photo">
                        <?=Html::img('@web/img/gift.png',['class'=>'img-responsive'])?>
                    </div>
                    <p class="inform-ver2">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 fea-column-inner">
                <div class="fea-box">
                    <div class="photo">
                        <?=Html::img('@web/img/fly.png',['class'=>'img-responsive'])?>
                    </div>
                    <p class="inform-ver2">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 fea-column-inner">
                <div class="fea-box">
                    <div class="photo">
                        <?=Html::img('@web/img/return.png',['class'=>'img-responsive'])?>
                    </div>
                    <p class="inform-ver2">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 fea-column-inner">
                <div class="fea-box">
                    <div class="photo">
                        <?=Html::img('@web/img/secu.png',['class'=>'img-responsive'])?>
                    </div>
                    <p class="inform-ver2">
...
<footer>
        ...
        <div class="container">
            <div class="row ">
                <div class="col-md-3 col-xs-12 ">
                    <div class="photo">
                        <a href="#"><?=Html::img('@web/img/logo.png',['class'=>'img-responsive'])?></a>
                    </div>
    ...
    <div class="copyright">
        <div class="container">
            ...
            <ul class="payment">
                <li><a href="#"><?=Html::img('@web/img/paypal.png',['class'=>'img-responsive'])?></a></li>
                <li><a href="#"><?=Html::img('@web/img/visa.png',['class'=>'img-responsive'])?></a></li>
                <li><a href="#"><?=Html::img('@web/img/american.png',['class'=>'img-responsive'])?></a></li>
                <li><a href="#"><?=Html::img('@web/img/mastercard.png',['class'=>'img-responsive'])?></a></li>
            </ul>
